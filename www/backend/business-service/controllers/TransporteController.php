...
include_once __DIR__ . '/../dtos/TransporteDTO.php';
include_once __DIR__ . '/../services/TransporteService.php';
...
class TransporteController {
    ...
    public function __construct() {
        ...
        $this->service = new TransporteService($this->db);
    }
