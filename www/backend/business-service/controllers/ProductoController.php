...
include_once __DIR__ . '/../dtos/ProductoDTO.php';
include_once __DIR__ . '/../services/ProductoService.php';
...
class ProductoController {
    ...
    public function __construct() {
        ...
        $this->service = new ProductoService($this->db);
    }
    ...
    public function getByCategoriaId($categoriaId) {
        $response = $this->service->getByCategoriaId($categoriaId);
        http_response_code($response['status']);
        echo json_encode($response['body']);
    }
