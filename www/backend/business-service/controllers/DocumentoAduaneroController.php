...
include_once __DIR__ . '/../dtos/DocumentoAduaneroDTO.php';
include_once __DIR__ . '/../services/DocumentoAduaneroService.php';

class DocumentoAduaneroController {
    private $service;
    private $db;
    ...
    public function __construct() {
        ...
        $this->service = new DocumentoAduaneroService($this->db);
    }
    ...
    public function create($data) {
        $dto = new DocumentoAduaneroDTO($data);
